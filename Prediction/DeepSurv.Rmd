...
# Loop over each pair, load data, train DeepSurv, and capture C-index and IBS
for (pair in all_pairs) {
  ...
  for (i in seq_along(times)) {
    t <- times[i]
    surv_prob_t <- predicted_survival_probs_ds[, i]  # Predicted survival probabilities for time t
...
write.csv(
  results_df,
  file      = "~/KDD_DeFi_Survival_Dataset_And_Benchmark/Survival_Prediction/Results/DeepSurv_final_results.csv",
  row.names = FALSE
)
...
knitr::kable(
  results_df,
  caption = "DeepSuvrv C-Index and IBS Results for All IndexEvent-OutcomeEvent Pairs"
)
